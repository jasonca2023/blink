...
#
# Usage:
#   scripts/generate-appcast.sh dist/Blink-1.1.0-7.dmg
#   scripts/generate-appcast.sh dist/Blink-1.1.0-7.dmg \
#       https://github.com/blink/blink/releases/download/v1.1.0/Blink-1.1.0-7.dmg
#
...
PROJECT="Blink.xcodeproj/project.pbxproj"
...
if [[ -z "$DOWNLOAD_URL" ]]; then
    DOWNLOAD_URL="https://github.com/blink/blink/releases/download/v${VERSION}/$(basename "$DMG_PATH")"
fi
...
if [[ -z "$ED_SIG" || -z "$LENGTH" ]]; then
    ...
    echo "Then update SUPublicEDKey in Blink/Info.plist with the printed public key." >&2
    exit 1
fi
...
<rss xmlns:sparkle="http://www.andymatuschak.org/xml-namespaces/sparkle" version="2.0">
    <channel>
        ...
        <link>https://github.com/blink/blink</link>
        <description>Blink direct-distribution updates.</description>
...
echo "  2. git add appcast.xml Blink.xcodeproj/project.pbxproj"
