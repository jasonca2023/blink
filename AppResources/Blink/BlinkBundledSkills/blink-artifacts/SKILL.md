...
## Fallbacks
- If no exact path is known, search likely output roots first: current workspace, `output/`, `tmp/`, Desktop, Downloads, and Blink Application Support.
