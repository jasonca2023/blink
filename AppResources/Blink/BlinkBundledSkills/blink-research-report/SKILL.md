...
- The user only wants to open/find a previously created report; use `blink-artifacts`.
...
4. Use internal capabilities as needed:
   ...
   - `blink-artifacts` for final open/reveal/export.
...
- End by opening or revealing the final artifact through `blink-artifacts`.
