...
Control the user's Spotify account via the Blink Spotify toolset (7 tools). Setup guide: https://blink-agent.nousresearch.com/docs/user-guide/features/spotify
