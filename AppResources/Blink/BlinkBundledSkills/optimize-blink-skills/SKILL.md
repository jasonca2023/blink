---
name: "optimize_blink_skills"
description: "Use when the user asks Blink to inspect, audit, improve, consolidate, or optimize bundled or learned skills."
---

# Optimize Blink Skills
...
6. Keep skill names snake_case and action-oriented, for example `create_apple_note` or `review_blink_logs`.
