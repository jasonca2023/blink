...
Blink maintains a local personal wiki of plain markdown notes the user (and Blink) has written about their projects, the people they care about, references, and anything else worth remembering across agent runs.
...
- Wiki content (curated notes): `~/Library/Application Support/Blink/wiki/wiki/`
- Raw saves (auto-captured snippets): `~/Library/Application Support/Blink/wiki/raw/`
- Index: `~/Library/Application Support/Blink/wiki/wiki/_index.md`
- Backlinks graph: `~/Library/Application Support/Blink/wiki/wiki/_backlinks.json`
...
```bash
cat "$HOME/Library/Application Support/Blink/wiki/wiki/_index.md"
```
...
cat "$HOME/Library/Application Support/Blink/wiki/wiki/Personality.md"

# Drafting about a project
cat "$HOME/Library/Application Support/Blink/wiki/wiki/projects/blink.md"

# Mentioning a person they know
cat "$HOME/Library/Application Support/Blink/wiki/wiki/people/blink-majeed.md"
```

If you don't know which note applies, grep:

```bash
grep -rli "<keyword>" "$HOME/Library/Application Support/Blink/wiki/wiki/"
```
