---
name: "learn_from_blink_logs"
description: "Use when the user asks Blink to review logs, find learnings, tune behavior from logs, or create improvements from logged messages."
---

# Learn From Blink Logs

Use this workflow when the user asks to review logs, learn from logs, tune Blink, inspect message JSONL, or turn flagged log comments into improvements.

## Required Inputs

1. Read `BlinkRuntimeMap.md` from Codex home.
2. Read `memory.md`.
...
- Repeated refusals where Blink should have started an agent task.
...
1. Create a timestamped backup under the archives path from `BlinkRuntimeMap.md`.
