...
struct CodexAgentModeTests {
    @Test func codexConfigRendersOpenAIResponsesContract() throws {
        let template = BlinkCodexConfigTemplate(
            model: "gpt-5.4",
        ...
        #expect(BlinkCodexConfigTemplate.defaultModelProviderID == "openai")
        #expect(!rendered.contains("[model_providers.blink]"))
        #expect(rendered.contains("model_instructions_file = \"BlinkModelInstructions.md\""))
        #expect(rendered.contains("bundled_skills_dir = \"BlinkBundledSkills\""))
    ...
    @Test func codexConfigKeepsCustomResponsesBackendAPIKeyBackcompat() throws {
        ...
        #expect(rendered.contains("model_provider = \"blink\""))
    ...
    @Test func cuaDriverMCPConfigurationPrefersExplicitBlinkOverride() throws {
    ...
    @Test func codexHomeManagerUsesBlinkResourceNames() throws {
        ...
        #expect(manager.modelInstructionsFileName == "BlinkModelInstructions.md")
        #expect(manager.bundledSkillsDirectoryName == "BlinkBundledSkills")
        #expect(manager.bundledWikiSeedDirectoryName == "BlinkBundledWikiSeed")
    ...
    @Test func logReviewSetupCreatesMarkdownAndJSONLFiles() throws {
        ...
        let store = BlinkMessageLogStore(logDirectory: directory)
    ...
    @MainActor @Test func implicitAgentRoutingKeepsVoiceRouteCapabilityQuestionsInVoiceRoute() throws {
        ...
        let withoutAgentInstruction = CompanionManager.implicitAgentTaskInstruction(from: "Could Blink browse without starting an agent?")
    ...
    @Test func codexInitializeRequestOptsIntoExperimentalAPIForResponsesClientMetadata() throws {
        let request = CodexProcessManager.makeInitializeRequest(clientName: "blink", title: "Blink", version: "1.0.0")
