...
enum BlinkAutomationSchedule: Codable, Equatable {
...
struct BlinkAutomation: Codable, Identifiable, Equatable {
  var id: UUID
  var name: String
  var schedule: BlinkAutomationSchedule
  var prompt: String
  ...
  init(id: UUID = UUID(), name: String, schedule: BlinkAutomationSchedule, prompt: String, agentSlug: String? = nil, enabled: Bool = true, lastRun: Date? = nil, nextRun: Date? = nil) {
    self.id = id
    self.name = name
