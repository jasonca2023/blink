...
//  durations baked into `BlinkBuddyAnimationRow`.
//
...
/// Translates Blink's existing buddy state machine + cursor velocity
/// into a row of the atlas.
enum BlinkBuddyAnimationState: Equatable {
    case idle
    case waiting
    case runningRight
    case runningLeft
    ...
    var row: BlinkBuddyAnimationRow {
        switch self {
...
struct BlinkPetSpriteView: View {
    let pet: BlinkBuddyPet
    let animationState: BlinkBuddyAnimationState
...
struct BlinkPetThumbnailView: View {
    let pet: BlinkBuddyPet
