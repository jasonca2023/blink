...
nonisolated struct BlinkWidgetSnapshot: Codable, Equatable {
...
nonisolated struct BlinkWidgetAgentSummary: Codable, Identifiable, Equatable {
    var id: UUID
    var title: String
    var status: String
    var caption: String?
...
nonisolated struct BlinkWidgetTodayStats: Codable, Equatable {
...
nonisolated struct BlinkWidgetAttentionItem: Codable, Identifiable, Equatable {
...
nonisolated struct BlinkWidgetPrivacySettings: Codable, Equatable {
...
nonisolated enum BlinkWidgetDeepLink {
