...
final class BlinkLogViewerWindowManager {
    ...
    func show() {
        if window == nil {
            createWindow()
        } else if let hostingView = window?.contentView as? NSHostingView<BlinkLogViewerView> {
    ...
    private func createWindow() {
        ...
        let hostingView = NSHostingView(rootView: BlinkLogViewerView())
        ...
        VStack(alignment: .leading, spacing: 10) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                Button {
                    ...
                    NSWorkspace.shared.open(BlinkMessageLogStore.shared.agentReviewCommentsFile)
                } label: {
