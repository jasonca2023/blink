...
enum BlinkBuddyAnimationRow: Int, CaseIterable {
    case idle           = 0
    case runningRight   = 1
    case runningLeft    = 2
    case waving         = 3
...
struct BlinkBuddyPetManifest: Decodable {
    let id: String
...
final class BlinkBuddyPet: Identifiable, Equatable {
    let id: String
    let displayName: String
...
enum BlinkBuddyPetLoaderError: Error {
