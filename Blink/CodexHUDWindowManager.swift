...
final class CodexHUDWindowManager {
    ...
    private func enforceMinimumSize() {
        ...
        let constrainedWidth = max(currentFrame.width, BlinkHUDLayout.minimumWidth)
        let constrainedHeight = max(currentFrame.height, BlinkHUDLayout.minimumHeight)
...
private struct HUDFloatingAgentButton: View {
    ...
    private var statusColor: Color {
        session.accentTheme.cursorColor
    }
}
