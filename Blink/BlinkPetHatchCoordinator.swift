//
//  BlinkPetHatchCoordinator.swift
//  Blink
//
...
@MainActor
final class BlinkPetHatchCoordinator {
    static let shared = BlinkPetHatchCoordinator()
    ...
    static func hatchPrompt(name: String, description: String) -> String {
        ...
        return """
        Use the hatch-pet skill to hatch a new Codex pet for Blink.
