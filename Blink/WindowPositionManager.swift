...
class WindowPositionManager {
    static let permissionDragAssistantMessage = "I'm Blink - drag me into the list above."
    ...
    private static let hasPreviouslyConfirmedScreenRecordingPermissionUserDefaultsKey = "com.blink.hasPreviouslyConfirmedScreenRecordingPermission"
...
private final class PermissionDragAssistantWindowManager {
    ...
    func show(message: String) {
        ...
        } else if let hostingView: NSHostingView<PermissionDragAssistantView> = BlinkLiquidGlassWindowSurface.hostingView(in: panel) {
