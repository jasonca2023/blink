...
final class OpenPetsCatalogStore: ObservableObject {
    ...
    func install(_ pet: OpenPetsCatalogPet, into library: BlinkBuddyPetLibrary) {
    ...
    private static func installPet(_ pet: OpenPetsCatalogPet, into petsRootURL: URL) async throws {
        ...
        let tempRoot = fm.temporaryDirectory.appendingPathComponent("BlinkOpenPets-")
    ...
    private static func validateExtractedPet(at url: URL, expectedPetID: String) throws {
        ...
        let manifest = try JSONDecoder().decode(BlinkBuddyPetManifest.self, from: data)
        ...
        _ = try BlinkBuddyPetLoader.loadPet(at: url)
    }
