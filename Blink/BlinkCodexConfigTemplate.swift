...
struct BlinkCodexConfigTemplate: Equatable {
    ...
    var modelProviderID: String {
        BlinkCodexBackend.isDefaultOpenAIBaseURL(workerBaseURL) ? Self.defaultModelProviderID : Self.customModelProviderID
    }
    ...
    private var preferredAuthMethod: String {
        BlinkCodexBackend.isDefaultOpenAIBaseURL(workerBaseURL) ? "chatgpt" : "apikey"
    }
