...
struct ChatWorkspaceView: View {
  ...
  @AppStorage("openBlinkAgentHUDSidebarVisible") private var sidebarVisible: Bool = false
  ...
  private var draftAutocompleteOptions: [BlinkPromptAutocompleteOption] {
  ...
  private var composer: some View {
    VStack(alignment: .leading, spacing: 8) {
      ...
      BlinkPromptAutocompletePanel(options: draftAutocompleteOptions) { option in
        BlinkPromptAutocomplete.apply(option, to: &draft)
      }
  ...
  private var currentModelLabel: String {
    ...
    let pool = BlinkModelCatalog.voiceResponseModels + BlinkModelCatalog.codexActionsModels
