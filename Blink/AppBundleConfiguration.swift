...
nonisolated enum AppBundleConfiguration {
    static let userAnthropicAPIKeyDefaultsKey = "openBlinkAnthropicAPIKey"
    static let userElevenLabsAPIKeyDefaultsKey = "openBlinkElevenLabsAPIKey"
    static let userElevenLabsVoiceIDDefaultsKey = "openBlinkElevenLabsVoiceID"
    static let userCartesiaAPIKeyDefaultsKey = "openBlinkCartesiaAPIKey"
    static let userCartesiaVoiceIDDefaultsKey = "openBlinkCartesiaVoiceID"
    static let userOpenAIRealtimeVoiceIDDefaultsKey = "openBlinkOpenAIRealtimeVoiceID"
    static let userMicrosoftEdgeVoiceIDDefaultsKey = "openBlinkMicrosoftEdgeVoiceID"
    /// Deepgram TTS reuses the existing Deepgram STT API key
    /// (`userDeepgramAPIKeyDefaultsKey`). Only the voice/model is
    /// TTS-specific.
    static let userDeepgramTTSVoiceDefaultsKey = "openBlinkDeepgramTTSVoice"
    static let userDeepgramVoiceAgentThinkModelDefaultsKey = "openBlinkDeepgramVoiceAgentThinkModel"
    static let userTTSProviderDefaultsKey = "openBlinkTTSProvider"
    static let openBlinkVoicePlaybackVolumeDefaultsKey = "openBlinkVoicePlaybackVolume"
    static let defaultVoicePlaybackVolume = 0.45
    static let userSpeculativePreFireDefaultsKey = "openBlinkSpeculativePreFireEnabled"
    static let userVoiceResponseCaptionsEnabledDefaultsKey = "openBlinkVoiceResponseCaptionsEnabled"
    static let userVoiceResponseCaptionFontDefaultsKey = "openBlinkVoiceResponseCaptionFont"
    static let userVoiceResponseCaptionOpacityDefaultsKey = "openBlinkVoiceResponseCaptionOpacity"
    static let defaultVoiceResponseCaptionOpacity = 0.92
    static let userAppFontDefaultsKey = "openBlinkAppFont"
    static let userAppTitleFontSizeDefaultsKey = "openBlinkAppTitleFontSize"
    static let userAppBodyFontSizeDefaultsKey = "openBlinkAppBodyFontSize"
    static let userAppSubtextFontSizeDefaultsKey = "openBlinkAppSubtextFontSize"
    static let userAppLineSpacingDefaultsKey = "openBlinkAppLineSpacing"
    static let userAppBoldTextDefaultsKey = "openBlinkAppBoldTextEnabled"
    static let userCodexAgentAPIKeyDefaultsKey = "openBlinkCodexAgentAPIKey"
    static let userAssemblyAIAPIKeyDefaultsKey = "openBlinkAssemblyAIAPIKey"
    static let userDeepgramAPIKeyDefaultsKey = "openBlinkDeepgramAPIKey"
    static let userVoiceTranscriptionProviderDefaultsKey = "openBlinkVoiceTranscriptionProvider"
    static let userAdvancedModeDefaultsKey = "openBlinkAdvancedModeEnabled"
    static let userComputerUseBackendDefaultsKey = "openBlinkComputerUseBackend"
    static let userNativeComputerUseDefaultsKey = "openBlinkNativeComputerUseEnabled"
    static let userMCPDeveloperDocsEnabledDefaultsKey = "openBlinkMCPDeveloperDocsEnabled"
    static let userMCPComputerUseEnabledDefaultsKey = "openBlinkMCPComputerUseEnabled"
    static let userMCPCuaDriverCommandDefaultsKey = "openBlinkMCPCuaDriverCommand"
    static let userDesktopNotificationsEnabledDefaultsKey = "openBlinkDesktopNotificationsEnabled"
    static let userWidgetsEnabledDefaultsKey = "openBlinkWidgetsEnabled"
    static let userWidgetsIncludeAgentTaskNamesDefaultsKey = "openBlinkWidgetsIncludeAgentTaskNames"
    static let userWidgetsIncludeMemorySnippetsDefaultsKey = "openBlinkWidgetsIncludeMemorySnippets"
    static let userWidgetsIncludeFocusedAppContextDefaultsKey = "openBlinkWidgetsIncludeFocusedAppContext"
    static let userGlassOpacityDefaultsKey = "openBlinkGlassOpacity"
    static let userGlassFrostingDefaultsKey = "openBlinkGlassFrosting"
    static let userThemeDefaultsKey = "openBlinkThemeAppearance"
    ...
    static func gogExecutablePath() -> String? {
        stringValue(
            forKey: "BlinkGogPath",
            environmentKeys: ["BLINK_GOG_PATH"]
        ) ?? localDevelopmentEnvironmentValue(forKey: "BLINK_GOG_PATH")
    }
    ...
    static func mcpCuaDriverCommand() -> String? {
        userDefaultsValue(forKey: userMCPCuaDriverCommandDefaultsKey)
            ?? stringValue(
                forKey: "BlinkCuaDriverMCPCommand",
    ...
    static func voicePlaybackVolume() -> Double {
        ...
        guard defaults.object(forKey: openBlinkVoicePlaybackVolumeDefaultsKey) != nil else {
            return defaultVoicePlaybackVolume
        }
        let volume = defaults.double(forKey: openBlinkVoicePlaybackVolumeDefaultsKey)
    ...
    private static func localDevelopmentEnvironmentFileURLs() -> [URL] {
        ...
        if let explicitSecretsFilePath = normalizedConfigurationValue(ProcessInfo.processInfo.environment["BLINK_SECRETS_FILE"]) {
        ...
        if let homeDirectory = fileManager.homeDirectoryForCurrentUser.path.removingPercentEncoding {
            urls.append(URL(fileURLWithPath: homeDirectory).appendingPathComponent(".config/blink/secrets.env"))
        }
