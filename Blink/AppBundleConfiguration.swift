...
enum AppBundleConfiguration {
    ...
    static let userHuggingFaceAPIKeyDefaultsKey = "openBlinkHuggingFaceAPIKey"
    ...
    static func huggingFaceAPIKey() -> String? {
        userDefaultsValue(forKey: userHuggingFaceAPIKeyDefaultsKey) ?? stringValue(
            forKey: "HuggingFaceAPIKey",
            environmentKeys: ["HUGGINGFACE_API_KEY", "HF_TOKEN"]
        ) ?? localDevelopmentEnvironmentValue(forKey: "HUGGINGFACE_API_KEY")
            ?? localDevelopmentEnvironmentValue(forKey: "HF_TOKEN")
    }
